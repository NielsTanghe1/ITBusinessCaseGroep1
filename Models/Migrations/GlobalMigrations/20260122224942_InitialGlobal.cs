...
{
    /// <inheritdoc />
    public partial class InitialGlobal : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUsers", x => x.CoffeeUserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_AspNetUsers_CoffeeUserId",
                        column: x => x.CoffeeUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "CoffeeUserId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_CoffeeUserId",
                        column: x => x.CoffeeUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "CoffeeUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentDetails_AspNetUsers_CoffeeUserId",
                        column: x => x.CoffeeUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "CoffeeUserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_CoffeeUserId",
                table: "Addresses",
                column: "CoffeeUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CoffeeUserId",
                table: "Orders",
                column: "CoffeeUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetails_CoffeeUserId",
