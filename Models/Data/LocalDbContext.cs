...
/// </summary>
public class LocalDbContext : IdentityDbContext<CoffeeUser, IdentityRole<long>, long> {
	/// <summary>
	...
	/// Called if the context is not configured via Dependency Injection.
	/// </summary>
	/// <param name="optionsBuilder">
	/// The builder for the context's configuration options.
	/// </param>
	protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
		// Define the connection string to the database
		string connectionString = "Server=(localdb)\\mssqllocaldb;Database=ITBusinessCoffee;Trusted_Connection=true;MultipleActiveResultSets=true";
